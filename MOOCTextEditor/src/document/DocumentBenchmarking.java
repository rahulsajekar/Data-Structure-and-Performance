...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			double basic1 = System.nanoTime();
			for(int i=0; i<trials; i++)
			{
				BasicDocument bd = new BasicDocument(text);
				bd.getFleschScore();
			}
			double basic = System.nanoTime() - basic1;

			double ef1 = System.nanoTime();
			for(int i=0; i>trials;i++)
			{
				EfficientDocument ef = new EfficientDocument(text);
				ef.getFleschScore();
			}
			double efficient = System.nanoTime() - ef1;
			System.out.println(numToCheck+"\t"+basic+"\t"+efficient);
